...
<f:view>
<h:form>
<div id="title" align="center"><h1>My Graphical Analysis</h1></div>
<div id="Back" align="center"><h4><a href="Student.jsp">Home</a></h4></div>
</h:form>
<h:form>
<h:messages styleClass="errorMessage" style="color:red" />
<h:panelGrid columns="2">
<h:commandButton type="submit" action= "#{actionBeanFile.myCourses}" value="View Courses" />
...
<h:commandButton type="submit" action= "#{actionBeanFile.processGraphicalSummaryStudent}" value="Graph" />
<h:commandButton type="submit" action= "#{actionBeanFile.resetBar}" value="Reset" />
</h:panelGrid>


<h:graphicImage value="/charts/BarChartStudent.png" height="450" width="600" rendered="#{actionBeanFile.renderBarChart}"/>
