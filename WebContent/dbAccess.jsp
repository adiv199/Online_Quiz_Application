...
<table>
<tr>
	<td><div align="center"><h3> Database for Online Assessment System</h3></div></td>
...
<h:panelGrid columns="2">
		...
		<h:form>
			...
			<h:commandButton type="submit" value="Add new user" action="#{databaseAccessBean.addUser}" />
			<h:commandButton type="submit" value="Logout" action="#{loginBean.logout}" />
		</h:panelGrid>
		<h:outputText value='User added successfully' style="color:blue" rendered='#{databaseAccessBean.userStatus}'/>
