...
@PostConstruct
	...
	public String Validate() {
		int check=0;
		try {
			String query="select * from f15g116_user;";
			...
			else
			{
				...
				*/
				...
				String insertLoginDetails = "INSERT INTO f15g116_logintracker"
						+ "(ipaddress,timestamp) VALUES" 
						+ "(?,?)";
				
				PreparedStatement preparedStatement = conn.prepareStatement(insertLoginDetails);
				preparedStatement.setString(1, clientIp);
				preparedStatement.setString(2, login_date);
	...
	public String validateDBLogin() {
		...
		try {						
				...
				if(dbUserName.equals("root") && dbPassword.equals("uiceadmysql") && 
				   (dbmsHost.equals("131.193.209.54") || dbmsHost.equals("131.193.209.57") || dbmsHost.equals("localhost")) &&
				   dbSchema.equals("f15g116") &&  dbms.equalsIgnoreCase("mysql"))
				{		
